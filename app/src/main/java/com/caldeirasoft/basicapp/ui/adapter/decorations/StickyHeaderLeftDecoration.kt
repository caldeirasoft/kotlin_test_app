 ...
 */
class StickyHeaderLeftDecoration <VH : RecyclerView.ViewHolder>
/**
 * @param mAdapter
            ...
            for (i in 1 until count) {
                ...
                if (adapterPosHere != RecyclerView.NO_POSITION) {
                    ...
                    if (nextId != currentId) {
                        ...
                        //这里计算offset画个图会很清楚
                        val offset = next.y.toInt() - (getHeader(parent, adapterPosHere).itemView.height)
