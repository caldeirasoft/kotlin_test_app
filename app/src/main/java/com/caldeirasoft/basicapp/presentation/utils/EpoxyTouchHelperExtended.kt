 ...
 */
object EpoxyTouchHelperExtended {
    ...
    class SwipeBuilder3<U : EpoxyModel<*>> constructor(
         ...
         * events via setting null on [ItemTouchHelper.attachToRecyclerView]
         */
        fun andCallbacks(callbacks: SwipeCallbacksExtended<U>): ItemTouchHelper {
    ...
    abstract class SwipeCallbacksExtended<T : EpoxyModel<*>> : EpoxySwipeCallback<T> {
         ...
         */
        fun isSwipeEnabledForModel(model: T): Boolean {
            return true
        }
